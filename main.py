...
# =============================================================================
# BAGIAN 1: INISIALISASI VARIABEL FUZZY
# =============================================================================
print("--- MEMULAI PROSES LATAR BELAKANG (BACKEND) ---")
print("[1/4] Menginisialisasi Variabel Fuzzy...")

# --- A. INPUT (ANTECEDENTS) ---
harga   = ctrl.Antecedent(np.arange(0, 31, 1), 'harga')      # 0 - 30 Juta
ram     = ctrl.Antecedent(np.arange(0, 25, 1), 'ram')        # 0 - 24 GB
rom     = ctrl.Antecedent(np.arange(0, 1025, 1), 'rom')      # 0 - 1 TB
baterai = ctrl.Antecedent(np.arange(0, 8000, 1), 'baterai')  # 0 - 8000 mAh
kamera  = ctrl.Antecedent(np.arange(0, 201, 1), 'kamera')    # 0 - 200 MP
antutu  = ctrl.Antecedent(np.arange(0, 2001, 1), 'antutu')   # 0 - 2 Juta

# --- B. OUTPUT (CONSEQUENT) ---
skor    = ctrl.Consequent(np.arange(0, 101, 1), 'skor')

# =============================================================================
# BAGIAN 2: FUNGSI KEANGGOTAAN (FINAL OPTIMIZED)
# =============================================================================
# 1. HARGA
...
# =============================================================================
# BAGIAN 3: GENERATOR ATURAN OTOMATIS
# =============================================================================
...
# =============================================================================
# BAGIAN 4: PEMROSESAN DATA & EXPORT JSON
# =============================================================================
...
try:
    ...
    hasil_skor = []
    hasil_ket = [] # List baru untuk menampung teks keterangan
    
    # Loop semua data (Tanpa Filter User)
    for i, row in df.iterrows():
        ...
        # --- LOGIKA KETERANGAN DIPINDAH KE SINI ---
        if nilai >= 70:
    ...
    df['Keterangan'] = hasil_ket # Kolom baru
    ...
    print("\nSekarang buka file index.html untuk melihat hasilnya.")
